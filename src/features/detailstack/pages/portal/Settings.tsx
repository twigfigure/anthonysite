...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div>
        <h1 className="ds-font-display text-3xl">Settings</h1>
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          <nav className="ds-glass rounded-sm p-2 space-y-1">
            {tabs.map((tab) => (
              <button
                key={tab.id}
        ...
        <div className="lg:col-span-3">
          {activeTab === 'business' && (
            <div className="ds-glass rounded-sm p-6 space-y-6">
              <h2 className="ds-font-display text-xl">Business Information</h2>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    defaultValue="DetailStack"
                    className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-2 text-white focus:outline-none focus:border-champagne-500/50"
                  />
                </div>
                <div>
                  ...
                  <input
                    type="email"
                    defaultValue="hello@detailstack.com"
                    className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-2 text-white focus:outline-none focus:border-champagne-500/50"
                  />
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="url"
                    defaultValue="https://detailstack.com"
                    className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-2 text-white focus:outline-none focus:border-champagne-500/50"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  defaultValue="8500 Sunset Blvd, West Hollywood, CA 90069"
                  className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-2 text-white focus:outline-none focus:border-champagne-500/50"
                />
              </div>
              ...
              <button className="ds-btn-primary flex items-center gap-2">
          ...
          {activeTab === 'notifications' && (
            <div className="ds-glass rounded-sm p-6 space-y-6">
              <h2 className="ds-font-display text-xl">Notification Preferences</h2>
          ...
          {activeTab === 'account' && (
            <div className="space-y-6">
              <div className="ds-glass rounded-sm p-6 space-y-6">
                <h2 className="ds-font-display text-xl">Account Settings</h2>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-champagne-500/30 to-champagne-600/10 flex items-center justify-center">
                    <span className="ds-font-display text-2xl text-champagne-400">JD</span>
                  </div>
                  <div>
                    <button className="text-sm text-champagne-400 hover:text-champagne-300">
                      Change Avatar
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="email"
                      defaultValue="john@detailstack.com"
                      className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-2 text-white focus:outline-none focus:border-champagne-500/50"
                    />
                  </div>
                </div>
              ...
              <div className="ds-glass rounded-sm p-6 space-y-6">
                <h2 className="ds-font-display text-xl flex items-center gap-2">
