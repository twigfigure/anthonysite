  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="ds-font-display text-3xl">Appointments</h1>
            ...
            >
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                  <h2 className="ds-font-display text-2xl">Appointment Details</h2>
                  <button
                    onClick={() => setSelectedAppointment(null)}
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex gap-2">
                    <button className="p-2 ds-glass rounded-sm text-obsidian-400 hover:text-white">
                      <Edit className="w-4 h-4" />
                    </button>
                    <button className="p-2 ds-glass rounded-sm text-red-400 hover:text-red-300">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button className="ds-btn-primary flex items-center justify-center gap-2">
