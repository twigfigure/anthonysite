    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass rounded-sm p-4">
          <div className="text-2xl font-display text-champagne-400">{customers.length}</div>
        ...
        <div className="glass rounded-sm p-4">
          <div className="text-2xl font-display text-white flex items-center gap-1">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-champagne-500/30 to-champagne-600/10 flex items-center justify-center">
                        <span className="font-display text-champagne-400">
