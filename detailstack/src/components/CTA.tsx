      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <h2 className="font-display text-5xl sm:text-6xl lg:text-7xl mb-6">
            ...
            <br />
            <span className="text-gradient-gold">the Treatment it Deserves?</span>
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/book" className="btn-primary text-lg flex items-center gap-2">
              Book Now
              <ChevronRight className="w-5 h-5" />
            </Link>
            <a href="tel:+13233714373" className="btn-secondary text-lg flex items-center gap-2">
