        ...
        <nav className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <Link to="/detailstack" className="flex items-center gap-3 group">
            ...
            <div className="hidden sm:block">
              <span className="ds-font-display text-2xl tracking-[0.2em] text-white">DETAIL</span>
              <span className="ds-font-display text-2xl tracking-[0.2em] text-champagne-400">STACK</span>
            </div>
          </Link>
            ...
            <nav className="relative h-full flex flex-col items-center justify-center gap-8 p-6">
              {navLinks.map((link, i) => (
                ...
                >
                  <a
                    ...
                    className="ds-font-display text-4xl tracking-wider text-white hover:text-champagne-400 transition-colors"
                  >
                    {link.label}
                  </a>
                </motion.div>
              ...
              >
                <Link
                  to="/detailstack/book"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="ds-btn-primary text-lg"
                >
                  Book Your Detail
                </Link>
              </motion.div>
