      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="ds-font-display text-5xl lg:text-6xl mt-4 mb-6">
            3 Convenient Spots <span className="ds-text-gradient-gold">Across LA</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {locations.map((location, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="ds-glass rounded-sm p-8 ds-card-hover text-center"
            >
              {/* Location Name */}
              <h3 className="ds-font-display text-2xl text-champagne-400 mb-6">{location.name}</h3>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="ds-glass rounded-sm p-8 lg:p-12 text-center ds-glow-gold"
        >
          <h3 className="ds-font-display text-3xl mb-4">
          ...
          <Link to="/detailstack/book" className="ds-btn-primary inline-flex items-center gap-2">
            Book Mobile Service
          </Link>
        </motion.div>
      </div>
