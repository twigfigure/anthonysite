...
export default function Book() {
  ...
  return (
    <div className="min-h-screen bg-obsidian-950 ds-page">
      {/* Header */}
      <header className="ds-glass sticky top-0 z-50 border-b border-obsidian-800/50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/detailstack" className="flex items-center gap-3 group">
            <div className="w-8 h-8 bg-gradient-to-br from-champagne-400 to-champagne-600 rounded-sm flex items-center justify-center">
              <span className="ds-font-display text-obsidian-950 text-sm tracking-wider">DS</span>
            </div>
            <span className="ds-font-display text-lg tracking-[0.15em]">
              <span className="text-white">DETAIL</span>
              <span className="text-champagne-400">STACK</span>
            </span>
          </Link>

          <Link to="/detailstack" className="text-sm text-obsidian-400 hover:text-white transition-colors flex items-center gap-2">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <AnimatePresence mode="wait">
              ...
              {currentStep === 1 && (
                ...
                >
                  <h2 className="ds-font-display text-3xl mb-2">Choose Your Service</h2>
                  ...
                  <div className="space-y-4">
                    {services.map((service) => (
                      <button
                        ...
                        className={`w-full ds-glass rounded-sm p-6 text-left transition-all ${
                          booking.service === service.id
                            ? 'border-champagne-500/50 ds-glow-gold'
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex justify-between items-start mb-2">
                              ...
                              <span className="text-champagne-400 ds-font-display text-xl">
                                ${service.price}
                              </span>
                            </div>
              ...
              {currentStep === 2 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="ds-font-display text-3xl mb-2">Vehicle Information</h2>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {vehicleTypes.map((type) => (
                        <button
                          ...
                          className={`ds-glass rounded-sm p-4 text-left transition-all ${
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-8">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-3 text-white placeholder:text-obsidian-500 focus:border-champagne-500/50 focus:ring-1 focus:ring-champagne-500/30 transition-all duration-200 outline-none"
                      />
                    </div>
                    <div>
                    ...
                    <div className="space-y-3">
                      {addOns.map((addOn) => (
                        <button
                          ...
                          className={`w-full ds-glass rounded-sm p-4 text-left transition-all flex justify-between items-center ${
              ...
              {currentStep === 3 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="ds-font-display text-3xl mb-2">Select Date & Time</h2>
                    ...
                    <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide">
                      {availableDates.map((date) => (
                        <button
                          ...
                          className={`flex-shrink-0 ds-glass rounded-sm p-4 text-center transition-all min-w-[100px] ${
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-5 gap-3">
                      {timeSlots.map((time) => (
                        <button
                          ...
                          className={`ds-glass rounded-sm py-3 px-4 text-center transition-all ${
                            booking.time === time
              ...
              {currentStep === 4 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="ds-font-display text-3xl mb-2">Choose Location</h2>
              ...
              {currentStep === 5 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="ds-font-display text-3xl mb-2">Your Details</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-3 text-white placeholder:text-obsidian-500 focus:border-champagne-500/50 focus:ring-1 focus:ring-champagne-500/30 transition-all duration-200 outline-none resize-none"
                      />
                    </div>
                  </div>
                </motion.div>
              ...
              {currentStep === 6 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="ds-font-display text-3xl mb-2">Payment</h2>
                  <p className="text-obsidian-400 mb-8">Secure payment powered by Stripe</p>

                  {/* Payment Form Placeholder */}
                  <div className="ds-glass rounded-sm p-8 mb-6">
                    <div className="space-y-4">
                      <div>
            ...
            <div className="flex justify-between mt-8 pt-8 border-t border-obsidian-800">
              ...
              {currentStep < 6 ? (
                ...
                <button className="ds-btn-primary flex items-center gap-2 text-lg">
          ...
          <div className="lg:col-span-1">
            <div className="ds-glass rounded-sm p-6 sticky top-24">
              <h3 className="ds-font-display text-xl mb-6">Booking Summary</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 mt-4 border-t border-obsidian-800">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="ds-font-display text-2xl text-champagne-400">
                        ${calculateTotal()}
                      </span>
                    </div>
                  </div>
