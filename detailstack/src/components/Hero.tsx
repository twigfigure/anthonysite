      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 py-32 lg:py-40">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              <h1 className="font-display text-6xl sm:text-7xl lg:text-8xl tracking-wide leading-[0.9]">
            ...
            >
              <Link href="/book" className="btn-primary flex items-center gap-2 text-lg">
                Book Your Detail
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -left-8 bottom-12 glass rounded-sm p-6 glow-gold"
            >
              <div className="text-4xl font-display text-champagne-400">10,000+</div>
