      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-display text-5xl lg:text-6xl mt-4 mb-6">
            Detailing Packages for <span className="text-gradient-gold">Every Need</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              <div
                className={`h-full glass rounded-sm p-8 card-hover ${
                  service.featured ? 'border-champagne-500/30 glow-gold' : ''
                }`}
              >
                {/* Featured Badge */}
                {service.featured && (
