      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            <Link to="/detailstack" className="flex items-center gap-3 mb-6">
              ...
              <div>
                <span className="ds-font-display text-xl tracking-[0.2em] text-white">DETAIL</span>
                <span className="ds-font-display text-xl tracking-[0.2em] text-champagne-400">STACK</span>
              </div>
            </Link>
            ...
            <div className="flex gap-3 mt-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full ds-glass-light flex items-center justify-center text-obsidian-400 hover:text-champagne-400 hover:border-champagne-500/30 transition-all"
                >
          ...
          {/* Services */}
          <div>
            <h4 className="ds-font-display text-lg tracking-wider text-white mb-4">Services</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="ds-font-display text-lg tracking-wider text-white mb-4">Company</h4>
            <ul className="space-y-3">
          ...
          {/* Support */}
          <div>
            <h4 className="ds-font-display text-lg tracking-wider text-white mb-4">Support</h4>
            <ul className="space-y-3">
          ...
          {/* Legal */}
          <div>
            <h4 className="ds-font-display text-lg tracking-wider text-white mb-4">Legal</h4>
            <ul className="space-y-3">
