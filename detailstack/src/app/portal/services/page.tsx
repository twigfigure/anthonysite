...
export default function ServicesPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Service Packages */}
      <div>
        <h2 className="font-display text-xl mb-4">Service Packages</h2>
        <div className="space-y-4">
          {packages.map((pkg, index) => (
            <motion.div
              ...
              className={`glass rounded-sm p-6 ${!pkg.active ? 'opacity-60' : ''}`}
            >
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="text-right">
                      <div className="font-display text-2xl text-champagne-400">${pkg.basePrice}</div>
      ...
      <div>
        <h2 className="font-display text-xl mb-4">Vehicle Type Pricing</h2>
            ...
            {[
              ...
              <div key={vehicle.type} className="bg-obsidian-800/50 rounded-sm p-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-champagne-400 font-display text-xl">{vehicle.modifier}</span>
