...
import OTexamAnalysis from "./features/otexam/pages/Analysis";
import OTexamAlerts from "./features/otexam/pages/Alerts";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/otexam/analysis" element={<OTexamAnalysis />} />
            <Route path="/otexam/alerts" element={<OTexamAlerts />} />
