  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="ds-font-display text-3xl">Team Management</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="ds-glass rounded-sm p-4">
          <div className="text-2xl ds-font-display text-champagne-400">
            {teamMembers.length}
          </div>
          <div className="text-sm text-obsidian-400">Team Members</div>
        </div>
        <div className="ds-glass rounded-sm p-4">
          <div className="text-2xl ds-font-display text-green-400">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredMembers.map((member) => (
          <motion.div
            ...
            className="ds-glass rounded-sm p-6 cursor-pointer hover:border-champagne-500/30 transition-all"
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-champagne-500/30 to-champagne-600/10 flex items-center justify-center">
                  <span className="ds-font-display text-xl text-champagne-400">{member.avatar}</span>
                </div>
                <div>
            ...
            <div className="grid grid-cols-3 gap-2 pt-4 border-t border-obsidian-800">
              <div className="text-center">
                <div className="ds-font-display text-lg text-white">{member.stats.jobsCompleted}</div>
                <div className="text-xs text-obsidian-500">Jobs</div>
              </div>
              <div className="text-center">
                <div className="ds-font-display text-lg text-white flex items-center justify-center gap-1">
              ...
              <div className="text-center">
                <div className="ds-font-display text-lg text-white">{member.stats.yearsExperience}y</div>
            ...
            >
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                  <h2 className="ds-font-display text-2xl">Team Member Details</h2>
                  <button
                    onClick={() => setSelectedMember(null)}
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-champagne-500/30 to-champagne-600/10 flex items-center justify-center">
                    <span className="ds-font-display text-2xl text-champagne-400">{selectedMember.avatar}</span>
                  </div>
                  <div>
                    <div className="ds-font-display text-xl text-white">{selectedMember.name}</div>
                ...
                {/* Contact Info */}
                <div className="ds-glass rounded-sm p-4 mb-4">
                ...
                <div className="ds-glass rounded-sm p-4 mb-4">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      <div className="ds-font-display text-2xl text-white">
                        {selectedMember.stats.jobsCompleted}
                      </div>
                      <div className="text-xs text-obsidian-500">Jobs Completed</div>
                    </div>
                    <div>
                      <div className="ds-font-display text-2xl text-white flex items-center justify-center gap-1">
                ...
                {/* Permissions */}
                <div className="ds-glass rounded-sm p-4 mb-6">
                  <h3 className="font-medium mb-3 flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button className="ds-btn-secondary flex items-center justify-center gap-2">
      ...
      <AnimatePresence>
        {showAddModal && (
          <>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className="ds-font-display text-2xl">Add Team Member</h2>
                <button
                  onClick={() => setShowAddModal(false)}
                  className="p-2 text-obsidian-400 hover:text-white transition-colors"
                >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-2 text-white placeholder:text-obsidian-500 focus:outline-none focus:border-champagne-500/50"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    type="email"
                    placeholder="john@detailstack.com"
                    className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-2 text-white placeholder:text-obsidian-500 focus:outline-none focus:border-champagne-500/50"
                  />
                </div>
                ...
                <div>
                  ...
                  <select className="w-full bg-obsidian-900 border border-obsidian-700 rounded-sm px-4 py-2 text-white focus:outline-none focus:border-champagne-500/50">
                    {roles.map((role) => (
                ...
                <div className="flex gap-3 pt-4">
                  <button
                    onClick={() => setShowAddModal(false)}
                    className="flex-1 ds-btn-secondary"
                  >
                    Cancel
                  </button>
                  <button className="flex-1 ds-btn-primary">
                    Send Invite
                  </button>
                </div>
              </div>
